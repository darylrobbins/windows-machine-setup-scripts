# Note
This project is forked from [microsoft/windows-dev-box-setup-scripts](https://github.com/microsoft/windows-dev-box-setup-scripts) and has been altered for my use. The difference is the scripts are adjusted for general and developer use, so it's not only a dev box.
...
`http://boxstarter.org/package/url?https://raw.githubusercontent.com/GITHUB_DOMAIN/windows-machine-setup-scripts/YOUR_BRANCH/RECIPE_NAME.ps1
`
...
### Method 1
Reference for [Web Launcher method](https://boxstarter.org/Learn/WebLauncher)

Set execution policy from an **elevated** PowerShell to unblock PowerShell from preventing Boxstarter running scripts.
```
Set-ExecutionPolicy Unrestricted -Force
```

You can install the Boxstarter modules by invoking module installer in PowerShell.
```powershell
. { iwr -useb https://boxstarter.org/bootstrapper.ps1 } | iex; Get-Boxstarter -Force
```
Now you can invoke `Install-BoxstarterPackage` command with our recipe. `-PackageName` can also point to any public Chocolatey package or plain text script.
```powershell
Install-BoxstarterPackage -PackageName http://boxstarter.org/package/url?https://raw.githubusercontent.com/exglade/windows-machine-setup-scripts/BRANCH_NAME/RECIPE_NAME.ps1
```

### Method 2 (Officially deprecated, but still works)
This method is deprecated according to the [Retiring the Boxstarter Web Launcher by Matt Wrock](http://www.hurryupandwait.io/blog/retiring-the-boxstarter-web-launcher). Otherwise, you require IE/Edge browser to run the ClickOnce installer.
...
|---------|---------|
|[Common Apps](http://boxstarter.org/package/url?https://raw.githubusercontent.com/exglade/windows-machine-setup-scripts/master/dev_common.ps1) | General |
|[Common Apps + SQL](http://boxstarter.org/package/url?https://raw.githubusercontent.com/exglade/windows-machine-setup-scripts/master/dev_analytics.ps1) | Data Analytics |
|[Web Dev](http://boxstarter.org/package/url?https://raw.githubusercontent.com/exglade/windows-machine-setup-scripts/master/dev_web.ps1) | ASP.NET Web Development |
